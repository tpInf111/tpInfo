...
DISCONNECTING : le client est en train de se déconnecter
*/
...
public class Client implements Lecteur {
     ...
     */
    public boolean connecter(GestionnaireEvenement gestionnaireEvenement) {
        //On crée l'écouteur d'événements pour le client :
        gestionnaireEvenementClient = gestionnaireEvenement;
        ...
        try {
            ...
            ecouteurTexte.start();  //la methode run() de l'écouteur de texte s'exécute en parallèle avec le reste du programme.
            resultat = true;
